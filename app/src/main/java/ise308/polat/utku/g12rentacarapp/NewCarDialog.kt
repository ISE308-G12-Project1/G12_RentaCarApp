...
class NewCarDialog : DialogFragment() {
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val editTextDeleteCar = newCarDialog?.findViewById<EditText>(R.id.edit_text_delete_car)
        val buttonRemove = newCarDialog?.findViewById<Button>(R.id.button_remove_fab)
        ...
        buttonRemove?.setOnClickListener {
            val callingActivity = activity as MainActivity
            callingActivity.deleteCars(editTextDeleteCar?.text.toString())
