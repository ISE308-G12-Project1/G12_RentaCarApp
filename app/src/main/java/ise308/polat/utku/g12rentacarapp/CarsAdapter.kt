...
class CarsAdapter(private val carList: ArrayList<Cars>, private val mainActivity: MainActivity) :
    ...
    inner class CarsViewHolder(carsItemView: View) : RecyclerView.ViewHolder(carsItemView),
        ...
        internal var textViewProductionYear =
            carsItemView.findViewById<TextView>(R.id.tv_production_year)
    ...
    override fun onBindViewHolder(holder: CarsViewHolder, position: Int) {
        ...
        holder.textViewProductionYear.text =
            "Car Production=> ${carsForDisplay.productionYear.toString()}"
